...
import { rendreSidebar, NAV_ITEMS } from "./shell.js";
...
const PANNEAUX = {
  ...
  performance: () => import("./panels/performance.js"),
  caisse: () => import("./panels/caisse.js"),
  "ma-caisse": () => import("./panels/ma-caisse.js"),
  utilisateurs: () => import("./panels/utilisateurs.js"),
  vehicules: () => import("./panels/vehicules.js"),
  hubs: () => import("./panels/hubs.js"),
  zones: () => import("./panels/zones.js"),
  "clients-pro": () => import("./panels/clients-pro.js"),
  abonnement: () => import("./panels/abonnement.js"),
  paiements: () => import("./panels/paiements.js"),
  personnalisation: () => import("./panels/personnalisation.js")
};
...
function idPanneauActif() {
  return (window.location.hash || "#commandes").replace("#", "");
}
