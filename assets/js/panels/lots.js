...
import { afficherFlash, escapeHtml, formaterFcfa, tampon, ouvrirModale, fermerModale } from "../ui.js";
    ...
    conteneur.innerHTML = `
      ...
      <div class="bloc-tableau">
        ...
        ${lots.length ? `
          ...
          </table>` : `<div class="etat-vide-tableau">Aucun lot créé.</div>`}
      </div>
    `;
